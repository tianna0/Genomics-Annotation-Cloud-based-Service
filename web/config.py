...
class Config(object):
  ...
  AWS_SNS_JOB_REQUEST_TOPIC = \
    "arn:aws:sns:us-east-1:659248683008:txin_job_requests"
  AWS_SNS_JOB_COMPLETE_TOPIC = \
    "arn:aws:sns:us-east-1:659248683008:txin_job_results"
  
  AWS_SQS_RESTORE_QUEUE_URL = "https://sqs.us-east-1.amazonaws.com/659248683008/txin_restore"

  # Change the table name to your own
  AWS_DYNAMODB_ANNOTATIONS_TABLE = "txin_annotations"
  AWS_DYNAMODB_PRIMARY_KEY = "job_id"

  # Change the email address to your username
  MAIL_DEFAULT_SENDER = "txin@mpcs-cc.com"
